/**
 * This file was originally generated by jsonrpcstub, but then manually 
 * modified, SO DO NOT REGENERATE THIS FILE!
 *
...
Csound.prototype.CompileCsdText = async function(csd_text, callbackSuccess, callbackError) {
    var params = {csd_text : csd_text};
    return this.doRPC("CompileCsdText", params, true, callbackSuccess, callbackError);
};
Csound.prototype.CompileOrc = async function(orc_code, callbackSuccess, callbackError) {
    var params = {orc_code : orc_code};
    return this.doRPC("CompileOrc", params, true, callbackSuccess, callbackError);
};
Csound.prototype.EvalCode = async function(orc_code, callbackSuccess, callbackError) {
    var params = {orc_code : orc_code};
    return this.doRPC("EvalCode", params, true, callbackSuccess, callbackError);
};
Csound.prototype.Get0dBFS = async function(callbackSuccess, callbackError) {
    var params = null;
    return this.doRPC("Get0dBFS", params, true, callbackSuccess, callbackError);
};
Csound.prototype.GetAudioChannel = async function(channel_name, callbackSuccess, callbackError) {
    var params = {channel_name : channel_name};
    return this.doRPC("GetAudioChannel", params, true, callbackSuccess, callbackError);
};
Csound.prototype.GetControlChannel = async function(channel_name, callbackSuccess, callbackError) {
    var params = {channel_name : channel_name};
    return this.doRPC("GetControlChannel", params, true, callbackSuccess, callbackError);
};
Csound.prototype.GetDebug = async function(callbackSuccess, callbackError) {
    var params = null;
    return this.doRPC("GetDebug", params, true, callbackSuccess, callbackError);
};
Csound.prototype.GetKsmps = async function(callbackSuccess, callbackError) {
    var params = null;
    return this.doRPC("GetKsmps", params, true, callbackSuccess, callbackError);
};
Csound.prototype.GetNchnls = async function(callbackSuccess, callbackError) {
    var params = null;
    return this.doRPC("GetNchnls", params, true, callbackSuccess, callbackError);
};
Csound.prototype.GetNchnlsInput = async function(callbackSuccess, callbackError) {
    var params = null;
    return this.doRPC("GetNchnlsInput", params, true, callbackSuccess, callbackError);
};
Csound.prototype.GetScoreOffsetSeconds = async function(callbackSuccess, callbackError) {
    var params = null;
    return this.doRPC("GetScoreOffsetSeconds", params, true, callbackSuccess, callbackError);
};
Csound.prototype.GetScoreTime = async function(callbackSuccess, callbackError) {
    var params = null;
    return this.doRPC("GetScoreTime", params, true, callbackSuccess, callbackError);
};
Csound.prototype.GetSr = async function(callbackSuccess, callbackError) {
    var params = null;
    return this.doRPC("GetSr", params, true, callbackSuccess, callbackError);
};
Csound.prototype.GetStringChannel = async function(channel_name, callbackSuccess, callbackError) {
    var params = {channel_name : channel_name};
...
Csound.prototype.IsScorePending = async function(callbackSuccess, callbackError) {
    var params = null;
...
Csound.prototype.ReadScore = async function(sco_code, callbackSuccess, callbackError) {
    var params = {sco_code : sco_code};
    return this.doRPC("ReadScore", params, true, callbackSuccess, callbackError);
};
Csound.prototype.RewindScore = async function(callbackSuccess, callbackError) {
    var params = null;
    return this.doRPC("RewindScore", params, true, callbackSuccess, callbackError);
};
Csound.prototype.ScoreEvent = async function(opcode_code, pfields, callbackSuccess, callbackError) {
...
Csound.prototype.TableLength = async function(table_number, callbackSuccess, callbackError) {
    var params = {table_number : table_number};
    return this.doRPC("TableLength", params, true, callbackSuccess, callbackError);
};
Csound.prototype.TableGet = async function(index, table_number, callbackSuccess, callbackError) {
