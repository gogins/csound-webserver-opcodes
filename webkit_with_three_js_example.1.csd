...
extern "C" int score_generator(CSOUND *csound) {
    ...
    pen.note[csound::Event::DURATION] = 0.1;
    ...
    auto g1 = [&chordsForTimes, &modality](const Cursor &pen_, int depth, csound::Score &score) {
        ...
        pen.note[csound::Event::TIME] = pen.note[csound::Event::TIME] * .501;
    ...
    auto g3 = [&chordsForTimes, &modality](const Cursor &pen_, int depth, csound::Score &score) {
        ...
        score.append(pen.note);
        pen.note[csound::Event::TIME] = (pen.note[csound::Event::TIME] * .5) + .001;
        pen.note[csound::Event::KEY] = (pen.note[csound::Event::KEY] * .4995) + 1;
    ...
    auto g4 = [&chordsForTimes, &modality](const Cursor &pen_, int depth, csound::Score &score) {
        ...
        score.append(pen.note);
        pen.note[csound::Event::TIME] = (pen.note[csound::Event::TIME] * .5) + .98;
        pen.note[csound::Event::KEY] = (pen.note[csound::Event::KEY] * .5) + 1.01;
